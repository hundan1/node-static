...
},{"./AssetManager":3,"./Audio":4,"./AudioEngine":5,"./DeviceMotionEvent":6,"./Editbox":1,"./Game":7,"./InputManager":8,"./Screen":9,"./Texture2D":10,"./misc":16}],16:[function(require,module,exports){
"use strict";
...
},{"../../common/engine":15,"../../common/engine/globalAdapter":14,"../../common/xmldom/dom-parser":18,"./wrapper/builtin":45,"./wrapper/engine":52,"./wrapper/error-reporter":54,"./wrapper/fs-utils":55,"./wrapper/sub-context-adapter":1,"./wrapper/systemInfo":56,"./wrapper/unify":57}],23:[function(require,module,exports){
"use strict";
...
},{"./Texture2D":51,"./VideoPlayer":1,"./pc-adapter":53}],53:[function(require,module,exports){
"use strict";
...
var utils = require('../../../common/utils'); // NOTE: size and orientation info is wrong at the init phase, especially on iOS device
  ...
  globalAdapter.getSafeArea = function () {
    ...
    if (systemInfo.platform === 'ios' && !globalAdapter.isDevTool && isLandscape()) {
      var tmpTop = top,
          ...
          tmpWidth = width,
          tmpHeight = height;
      var bottomHeight = windowWidth - tmpBottom;
